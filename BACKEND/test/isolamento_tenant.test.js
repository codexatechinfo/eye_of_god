...
// demais. scalefusion e segsat (integrações de posição/bateria e de
// mapeamento placa↔colaborador) já nasceram com a mesma policy — testadas
// aqui junto por conveniência, mesmo padrão de verificação (fail-closed +
// isolamento cross-empresa).
for (const tabela of ['calendario_leitura', 'cidades_localidades', 'tab_ligacao_coordenadas', 'scalefusion', 'segsat']) {
